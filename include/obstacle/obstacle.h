...
public:
  ...
  /**
    * @brief Check if a given line segment between two points intersects with the obstacle (and additionally keeps a safety distance \c min_dist)
...
public:
  ...
  */
  ...
  virtual bool checkCollision(const Eigen::Vector2d& point, double min_dist) const
  {
      ...
      // point in polygon test - ray casting (http://www.ecse.rpi.edu/Homepages/wrf/Research/Short_Notes/pnpoly.html)
